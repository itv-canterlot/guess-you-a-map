...
var map = new ol.Map({
  target: 'map',
  // layers: [osm, land_use_vectors, natural_vectors, building_vectors, ped_vectors, land_use_vectors, aux_vectors, res_rd_vectors, vectors, aeroway_vectors, amenity_vectors],
  layers: [land_use_vectors, natural_vectors, building_vectors, ped_vectors, aux_vectors, res_rd_vectors, unc_vectors, tert_vectors, vectors, aeroway_vectors, amenity_vectors],
  view: new ol.View({
